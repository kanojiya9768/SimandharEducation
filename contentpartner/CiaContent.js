                    ...
                    <div className="cont-partner-container">
                        ...
                        <div className="cont-partner-row">
                            ...
                            <div className="content-box p2">
                                ...
                                <div className='download-overlay' onClick={showDwnPopup1} style={{ display: isShow1 ? 'block' : 'none' }}>
                                </div>
                                <div className='download-popup' style={{ display: !isShow1 ? 'none' : 'block' }}>
                                    ...
                                    <DownloadFormComponents showHeading2={true} indexData={indexData.downloadProspectus} DownloadForm={indexData.SimandharCIA} formName="CIA Download Prospectus" /></div>
                            </div>
                        </div>
                    </div>
                </div>
