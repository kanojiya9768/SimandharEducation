                        ...
                        {/* <div className="cont-partner-row">
                            ...
                            <div className="content-box p2">
                                ...
                                <div className='download-popup right-form-box backer' style={{ display: !isShow ? 'none' : 'block' }}>
                                    ...
                                    <CommonForm showIcon={true} showcourse={true} showHeading2={true} showTitle={true} indexData={indexData.CpaCOntentPartner} formName="DA Free Becker 15 Days Trial " />
                                </div>
                            </div>
                        </div> */}
                        ...
                        <div className="cont-partner-row">
                            ...
                            <div className="content-box p2">
                                ...
                                <div className='download-popup' style={{ display: !isShow1 ? 'none' : 'block' }}>
                                    ...
                                    <DownloadFormComponents showHeading2={true} indexData={indexData.downloadProspectus} DownloadForm={indexData.SimandharDA} formName="DA Download Prospectus" /></div>
                            </div>
                        </div>
                    </div>
                </div>
