                        ...
                        <div className="cont-partner-row">
                            ...
                            <div className="content-box p2">
                                ...
                                <div className='download-popup' style={{ display: !isShow1 ? 'none' : 'block' }}>
                                    ...
                                    <DownloadFormComponents showHeading2={true} indexData={indexData.downloadProspectus} DownloadForm={indexData.SimandharIFRS} formName="EA Download Prospectus" /></div>
                            </div>
                        </div>
                    </div>
                </div>
